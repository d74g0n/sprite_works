class Prisoner {
    ...
    this.draw_legs_walk = function (x, y) {
        ...
        if (this.vx == 0 && this.vy == 0) {
            //idle pose:
            this.ctx.drawImage(global.spirtesheet, 5 * global.raw_scale, 0 * global.raw_scale, global.raw_scale, global.raw_scale, x, y, global.draw_scale, global.draw_scale);
            //front leG:
            this.ctx.drawImage(global.spirtesheet, 5 * global.raw_scale, 0 * global.raw_scale, global.raw_scale, global.raw_scale, x-1*0.9, y, global.draw_scale*0.9, global.draw_scale);
